...
@section('title', 'Edit ' . ucfirst($admin->role))
            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center gap-3">
                        <div class="h-10 w-10 {{ $admin->role === 'admin' ? 'bg-blue-600' : 'bg-indigo-600' }} rounded-xl flex items-center justify-center text-white">
                            @if($admin->role === 'admin')
                        ...
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">Edit {{ ucfirst($admin->role) }}</h2>
                    </div>
                ...
                <form action="{{ route('admin-management.update', $admin) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 ml-1">Password (Biarkan kosong jika tidak diubah)</label>
