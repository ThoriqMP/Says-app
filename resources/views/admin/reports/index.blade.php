                ...
                <div class="bg-white dark:bg-gray-800 rounded-[32px] border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden flex flex-col">
                    ...
                    <div class="p-6 pt-0 space-y-3">
                        <div class="flex gap-2">
                            <a href="{{ route('student.reports.show', $report) }}" class="flex-1 py-3.5 bg-gray-900 dark:bg-gray-700 text-white rounded-2xl font-black text-sm text-center hover:bg-blue-600 transition-colors active:scale-95">
                                Detail
                            </a>
                        ...
                        <a href="{{ route('student.reports.pdf', $report) }}" class="flex items-center justify-center gap-2 w-full py-3.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-2xl font-black text-sm hover:bg-blue-100 transition-colors active:scale-95">
