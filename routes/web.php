...
Route::middleware(['auth'])->group(function () {
    // Admin Management Routes (Only for Pimpinan)
    Route::middleware(['pimpinan'])->prefix('admin-management')->name('admin-management.')->group(function () {
    ...
    // Subjects Routes
    Route::middleware('permission:subjects.index')->group(function () {
    ...
    Route::middleware('permission:school-profile.edit')->group(function () {
    ...
    Route::middleware('permission:assessments.index')->group(function () {
    ...
    Route::middleware('permission:psychological-assessments.index')->prefix('/psychological-assessments')->name('psychological-assessments.')->group(function () {
